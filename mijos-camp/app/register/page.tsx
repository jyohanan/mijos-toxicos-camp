    ...
    <div className="space-y-5">
      ...
      <div className="max-h-80 space-y-5 overflow-y-auto rounded-xl border border-white/[0.08] bg-white/[0.02] p-5 text-sm leading-7 text-white/55">
        <div>
          ...
          <p>I, the undersigned parent or legal guardian, acknowledge that participation in the Mijos Tóxicos Dual Sports Camp (&quot;the Event&quot;) involves inherent risks, including but not limited to physical contact, falls, collisions, sprains, fractures, concussions, heat-related illness, and other injuries that may result from athletic activity. I understand that these risks exist regardless of the precautions taken by the Event organizers.</p>
